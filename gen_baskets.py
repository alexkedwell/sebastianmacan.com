...
ITEMS = {
    ...
    "Ghost":   ("Granular Freeze FX", "Haunted-tape freezes and ghostly trails.", 19, "ghost.html",   "downloads/Ghost-v1.1-macOS.pkg"),
    "Liftoff": ("Riser & Transition FX", "Build-ups that actually take off.", 19, "liftoff.html", "downloads/Liftoff-v1.0-macOS.pkg"),
    "Orbit":   ("Motion & Pan FX", "Sounds that circle your head.", 19, "orbit.html",   "downloads/Orbit-v1.0-macOS.pkg"),
    "Reels":   ("Tape Emulation", "Warm wobble, hiss and vintage glue.", 19, "reels.html",   "downloads/Reels-v1.0-macOS.pkg"),
    "Gloss":   ("Polish & Shine FX", "Instant top-end sparkle and width.", 19, "gloss.html",   "downloads/Gloss-v1.0-macOS.pkg"),
    "Halo":    ("Reverb & Glow", "Space that hugs your sound.", 19, "halo.html",    "downloads/Halo-v1.0-macOS.pkg"),
    ...
    "Fauna":   ("Creature Synth", "An ecosystem of playable creatures.", 29, "fauna.html",   "downloads/Fauna-v1.0-macOS.pkg"),
    "Jelly":   ("Wobble FX", "Free forever. The pink blob wobbles.", 0, "jelly.html",  "downloads/Jelly-v1.0-macOS.pkg"),
    "Bounce":  ("Stutter & Beat Repeat", "Free forever. Chop it up.", 0, "bounce.html", "downloads/Bounce-v1.0-macOS.pkg"),
